...
async def run_live(config_path: str, dry_run: bool = None):
    ...
    sheet_id = os.environ.get("GOOGLE_SHEETS_24H_ID") or cfg["sheets"]["sheet_id"]
    ...
    async with local_HL(
        ...
        while True:
            ...
            if last_ts is not None and ts <= last_ts:
                ...
                interval_seconds = interval_map.get(interval, 86400)
                ...
                wait_seconds = max(5, min(seconds_until_next, 600))  # Cap at 10min for 24h bot
