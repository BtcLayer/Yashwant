...
<<<<<<< HEAD
    def __init__(self, ws_url: str, addresses: List[str], coin: str = "BTC", mode: str = "public_trades"):
        """
...
<<<<<<< HEAD
                    ...
                    if isinstance(data, dict) and data.get("type") == "trades" and isinstance(data.get("data"), list):
=======
                    if (
...
<<<<<<< HEAD
        ...
        size = float(t.get('size') or t.get('sz') or t.get('q') or t.get('qty') or t.get('quantity') or 0)
