...
def _load_build_llm_context_pack():
    ...
    Tries repo-level ops.llm_logging first, then package-local live_demo_1h.ops.llm_logging.
    """
    try:
    ...
    try:
        mod = importlib.import_module("live_demo_1h.ops.llm_logging")
        return getattr(mod, "build_llm_context_pack")
    except ModuleNotFoundError:
        pass

    raise ModuleNotFoundError(
        "Unable to import 'build_llm_context_pack' from ops.llm_logging or live_demo_1h.ops.llm_logging"
    )
