...
<<<<<<< HEAD
    def poll_last_closed_kline(self) -> Optional[Tuple[int, float, float, float, float, float]]:
...
<<<<<<< HEAD
        ...
        ot, o, h, l, c, v = int(k[-2][0]), float(k[-2][1]), float(k[-2][2]), float(k[-2][3]), float(k[-2][4]), float(k[-2][5])
=======
        ot, o, h, l, c, v = (
            int(k[-2][0]),
            float(k[-2][1]),
