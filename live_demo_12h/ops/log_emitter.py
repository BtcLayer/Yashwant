...
class LogEmitter:
    ...
    def emit_signals(self, *, ts: Optional[float], symbol: str, features: Dict[str, Any], model_out: Dict[str, Any], decision: Dict[str, Any], cohort: Dict[str, Any]):
        payload = {
            'symbol': symbol,
    ...
    def emit_ensemble(self, *, ts: Optional[float], symbol: str, raw_preds: Dict[str, Any], meta: Dict[str, Any]):
        payload = {
            'symbol': symbol,
    ...
    def emit_execution(self, *, ts: Optional[float], symbol: str, exec_resp: Dict[str, Any], risk_state: Dict[str, Any]):
        payload = {
            'symbol': symbol,
