...
<<<<<<< HEAD
    ...
    globals().setdefault('CustomClassificationCalibrator', CustomClassificationCalibrator)
...
=======
        ...
        self.calibrator_path = (
            abs_path(m.get("calibrator")) if m.get("calibrator") else None
        )
        self.feature_schema_path = abs_path(m["feature_columns"])
>>>>>>> a425beb9a39dcb2c03ba879f40b73a3beb6babde
        try:
...
<<<<<<< HEAD
            print(f"[ModelRuntime] Warning: failed to load calibrator '{self.calibrator_path}': {e}")
