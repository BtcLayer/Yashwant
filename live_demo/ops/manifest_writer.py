...
class ManifestWriter:
    ...
    def __init__(self, run_id: str, asset: str, output_dir: str, interval: str):
        ...
        # Adaptive update intervals (in bars)
        ...
        self.update_interval = self.update_intervals.get(interval, 50)
    ...
    def initialize(self, config_path: str = None, code_path: str = None, model_manifest_path: str = None):
        ...
        if not code_path:
            # Assume main.py is in live_demo/main.py relative to this file
            # This file is now in live_demo/ops/manifest_writer.py
            potential_paths = [
                os.path.join(os.path.dirname(__file__), '..', 'main.py'),
                os.path.join(os.path.dirname(__file__), '..', '..', 'live_demo', 'main.py')
            ]
