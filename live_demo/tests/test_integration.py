...
async def test_overlay_integration():
    ...
    mock_bars = [
        {"timestamp": "2025-10-22T10:05:00+05:30", "bar_id": 1, "open": 50000, "high": 50100, "low": 49900, "close": 50050, "volume": 100, "funding": 0.0001, "spread_bps": 2.0, "rv_1h": 0.02},
        {"timestamp": "2025-10-22T10:10:00+05:30", "bar_id": 2, "open": 50050, "high": 50150, "low": 50000, "close": 50100, "volume": 120, "funding": 0.0002, "spread_bps": 2.5, "rv_1h": 0.025},
        {"timestamp": "2025-10-22T10:15:00+05:30", "bar_id": 3, "open": 50100, "high": 50200, "low": 50050, "close": 50150, "volume": 110, "funding": 0.0003, "spread_bps": 3.0, "rv_1h": 0.03},
        {"timestamp": "2025-10-22T10:20:00+05:30", "bar_id": 4, "open": 50150, "high": 50250, "low": 50100, "close": 50200, "volume": 130, "funding": 0.0004, "spread_bps": 2.8, "rv_1h": 0.035},
        {"timestamp": "2025-10-22T10:25:00+05:30", "bar_id": 5, "open": 50200, "high": 50300, "low": 50150, "close": 50250, "volume": 140, "funding": 0.0005, "spread_bps": 3.2, "rv_1h": 0.04},
    ]
    
    for bar_data in mock_bars:
        overlay_bars = overlay_system.add_market_data(bar_data)
        print(f"   Added bar {bar_data['bar_id']}, generated overlays: {list(overlay_bars.keys())}")
    ...
    for tf, tf_status in status['timeframe_status'].items():
        print(f"     {tf}: {tf_status['bar_count']} bars, ready: {tf_status['is_ready']}")
    ...
    try:
        ...
        print(f"   Decision: direction={decision.direction}, alpha={decision.alpha:.3f}, confidence={decision.confidence:.3f}")
    ...
    try:
        ...
        for tf, signals in timeframe_signals.items():
            print(f"   {tf}: {signals.get('signal_count', 0)} signals, hit rate: {signals.get('hit_rate', 0):.3f}")
    except Exception as e:
