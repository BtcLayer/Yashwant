...
class CalibrationEnhancer:
    ...
    def log_calibration(
        ...
        band_hit_rate = self.band_hits / self.total_predictions if self.total_predictions > 0 else 0.0
    ...
    def get_calibration_log(self, ts: float, asset: str, bar_id: int) -> Optional[Dict[str, Any]]:
    ...
    def log_calibration_dict(
        ...
        calibration_log = self.log_calibration(ts, bar_id, asset, calibration_params, prediction, realized_return)
        if calibration_log:
            return {
    ...
    def get_calibration_statistics(self) -> Dict[str, Any]:
        ...
        prediction_accuracies = [log.prediction_accuracy for log in self.calibration_history]
